...
namespace TowerDefense.UI.HUD
{
	...
	public class GameUI : Singleton<GameUI>
	{
		...
		public void UpgradeSelectedTower()
		{
			...
			bool successfulUpgrade = LevelManager.instance.currencyDefender.TryPurchase(upgradeCost);
		...
		public void SellSelectedTower()
		{
			...
			{
				LevelManager.instance.currencyDefender.AddCurrency(sellValue);
		...
		public bool BuyTower()
		{
			...
			bool successfulPurchase = LevelManager.instance.currencyDefender.TryPurchase(cost);
		...
		public bool IsValidPurchase()
		{
			...
			return LevelManager.instance.currencyDefender.CanAfford(m_CurrentTower.controller.purchaseCost);
		}
		...
		public void PlaceTower()
		{
			...
			LevelManager.instance.activeTowers.Add(createdTower);
			LevelManager.instance.activeTowersWithType.Add(LevelManager.instance.nameToTypeDictTowers[createdTower.towerName]);
		...
		protected virtual void OnEnable()
		{
			...
			{
				if(LevelManager.instance.currencyDefender != null)
				{
                    LevelManager.instance.currencyDefender.currencyChanged += OnCurrencyChanged;
                }
            }
		}
